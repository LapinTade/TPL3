...
/**
 * Classe abstraite représentant un calcul binaire entre expressions valuées. 
 * @author Frederic Dadeau - frederic.dadeau@univ-fcomte.fr
 *
 */
public abstract class Calcul extends ExpressionValuee {
	 ...
	 */
	public Calcul(ExpressionValuee op1, ExpressionValuee op2) {
		operande1 = op1;
		operande2 = op2;
	}
