...
/**
 * Classe représentant une conjonction entre deux opérandes booleennes.
 * @author Frederic Dadeau - frederic.dadeau@univ-fcomte.fr
 *
 */
public class Et extends ExpressionBooleenne {
	...
	/**
	 * Constructeur de conjonction.
	 * @param op1 la première opérande
	 * @param op2 la seconde opérande
	 */
	public Et(ExpressionBooleenne op1, ExpressionBooleenne op2) {
		operande1 = op1;
		operande2 = op2;
	}
